...
\item Modalita reward:
  ...
  \texttt{rl.reward.mode: pymgrid} usa direttamente la \texttt{base\_reward}
  restituita da \texttt{microgrid.step}.
...
\item La reward finale usata dall'agente dipende da \texttt{rl.reward.mode}:
  ...
  coincide con la \texttt{base\_reward} del simulatore.
\end{itemize}
